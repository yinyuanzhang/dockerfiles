...
RUN adduser --comment "RPM EL7 Builder" --home /home/builder --create-home builder ; mkdir -p /home/builder/rpms/{BUILD,SPECS,SOURCES,RPMS,SRPMS} ; chown -R builder /home/builder
