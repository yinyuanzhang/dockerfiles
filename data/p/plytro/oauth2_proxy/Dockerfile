...
ENV OAUTH2_PROXY_VERSION 2.2.1.linux-amd64.go1.10.1

RUN apk --update add curl

RUN curl -sL -o oauth2_proxy.tar.gz \
    "https://github.com/plytro/oauth2_proxy/releases/download/v2.2.1/oauth2_proxy-$OAUTH2_PROXY_VERSION.tar.gz" \
