...
RUN apt-key adv --keyserver hkp://keyserver.ubuntu.com:80 --recv E1DD270288B4E6030699E45FA1715D88E1DF1F24 \
 ...
 && DEBIAN_FRONTEND=noninteractive apt-get install -y sudo supervisor logrotate locales wget curl \
      nginx openssh-server openssh-client mysql-client postgresql-client redis-tools \
      git-core ruby${RUBY_VERSION} libkrb5-dev python2.7 python-docutils nodejs gettext-base \
      libmysqlclient20 libpq5 zlib1g libyaml-0-2 libssl1.0.0 \
      libgdbm3 libreadline6 libncurses5 libffi6 \
      libxml2 libxslt1.1 libcurl3 libicu55 vim-tiny \
