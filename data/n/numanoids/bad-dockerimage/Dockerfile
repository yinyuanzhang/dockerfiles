...
#
RUN curl -LO ${CURL_OPTIONS} \
      http://vault.centos.org/7.2.1511/updates/x86_64/Packages/java-1.8.0-openjdk-1.8.0.91-0.b14.el7_2.x86_64.rpm && \
    curl -LO ${CURL_OPTIONS} \
      http://vault.centos.org/7.2.1511/updates/x86_64/Packages/java-1.8.0-openjdk-headless-1.8.0.91-0.b14.el7_2.x86_64.rpm && \
    touch /var/lib/rpm/* && \
...
#
RUN curl -LO ${CURL_OPTIONS} \
      https://ftp.gnu.org/gnu/bash/bash-4.3.tar.gz && \
