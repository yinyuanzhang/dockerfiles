...
LABEL org.label-schema.build-date=$BUILD_DATE \
      ...
      org.label-schema.description="a Concourse resource for caching dependencies downloaded by NPM - built on node." \
      org.label-schema.url="https://github.com/bubbltrubl/npm-cache-resource" \
      org.label-schema.vcs-ref=$VCS_REF \
      org.label-schema.vcs-url="https://github.com/bubbltrubl/npm-cache-resource" \
