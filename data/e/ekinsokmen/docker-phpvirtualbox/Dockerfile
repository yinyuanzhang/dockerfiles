...
RUN wget  http://sourceforge.net/projects/phpvirtualbox/files/phpvirtualbox-5.0-2.zip/download -O phpvirtualbox-5.0-2.zip
RUN unzip phpvirtualbox-5.0-2.zip
RUN mv phpvirtualbox-5.0-2 /var/www
