...
RUN git clone --depth=1 https://github.com/exedox/doge-1 /doge && git clone --depth=1 https://github.com/exedox/nut /doge/nut && apk del zlib-dev git alpine-sdk libffi-dev musl-dev openssl-dev
