...
# DIRECTORY to
ADD . /usr/local/docker-test-project
...
RUN cd /usr/local/docker-test-project && mvn assembly:assembly
...
CMD ["java", "-cp", "/usr/local/docker-test-project/target/docker-test-project-0.0.1-SNAPSHOT-jar-with-dependencies.jar", "com.webfg.docker.HelloWorldPing"]