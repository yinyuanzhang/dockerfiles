FROM tomcat:9.0.0.M22-jre8-alpine
...
LABEL "maintainer"="cloudsquad@fxinnovation.com" \
      "org.label-schema.name"="pinpoint-tomcat9" \
      "org.label-schema.base-image.name"="docker.io/library/tomcat" \
      "org.label-schema.base-image.version"="9.0.0.M22-jre8-alpine" \
      "org.label-schema.description"="pinpoint-agent with tomcat 9 in a container" \
      "org.label-schema.url"="https://github.com/naver/pinpoint" \
      "org.label-schema.vcs-url"="https://bitbucket.org/fxadmin/public-common-docker-pinpoint_tomcat9" \
      ...
      "org.label-schema.usage"="https://bitbucket.org/fxadmin/public-common-docker-pinpoint_tomcat9"
