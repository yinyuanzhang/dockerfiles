...
# Install Android SDK
RUN wget https://dl.google.com/android/android-sdk_r${ANDROID_SDK_TOOLS}-linux.tgz
RUN tar -xvzf android-sdk_r${ANDROID_SDK_TOOLS}-linux.tgz
RUN mv android-sdk-linux /usr/local/android-sdk
RUN rm android-sdk_r${ANDROID_SDK_TOOLS}-linux.tgz

ENV ANDROID_COMPONENTS platform-tools,android-${ANDROID_COMPILE_SDK},build-tools-${ANDROID_BUILD_TOOLS}
...
ENV PATH $PATH:$ANDROID_SDK_HOME/build-tools/${ANDROID_BUILD_TOOLS}
