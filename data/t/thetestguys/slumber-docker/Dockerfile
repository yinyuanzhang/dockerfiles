...
COPY build_slumber.zip /var/jenkins_home/jobs/build_slumber.zip
RUN unzip /var/jenkins_home/jobs/build_slumber.zip && rm /var/jenkins_home/jobs/build_slumber.zip
