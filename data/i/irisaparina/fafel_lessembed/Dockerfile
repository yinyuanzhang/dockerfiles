...
RUN curl -s -L https://raw.githubusercontent.com/saparina/fafel_lessembed/master/run.sh?token=AVTxeLwemIFpJgrdij88-_bf6iLYEQCRks5afgZYwA%3D%3D -o ~/run.sh && chmod +x ~/run.sh
