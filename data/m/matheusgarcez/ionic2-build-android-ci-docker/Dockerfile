...
RUN ( sleep 5 && while [ 1 ]; do sleep 1; echo y; done ) | /opt/android-sdk-linux/tools/android update sdk --all --no-ui --filter platform-tools,build-tools-24.0.2,android-24,extra-android-support,extra-google-m2repository,extra-android-m2repository
