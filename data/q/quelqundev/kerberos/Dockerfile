...
RUN	git clone https://github.com/quelqundev/machinery -b develop /tmp/machinery && \
...
RUN git clone https://github.com/baudev/web -b develop /var/www/web && cd /var/www/web && git checkout ${APP_ENV} && \
