...
# php && httpd
RUN yum -y install php56w php56w-opcache php56w-cli php56w-common php56w-gd php56w-intl php56w-mbstring php56w-mcrypt php56w-mysql php56w-mssql php56w-pdo php56w-pear php56w-soap php56w-xml php56w-xmlrpc httpd
