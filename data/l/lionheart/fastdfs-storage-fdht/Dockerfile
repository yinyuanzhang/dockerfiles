...
RUN git clone https://github.com/happyfish100/libfastcommon.git ${FASTDFS_PATH}/libfastcommon \
 ...
 && wget "http://download.oracle.com/berkeley-db/db-${BERKELEY_DB_VERSION}.tar.gz" -P ${FASTDFS_PATH}/download \
 ...
 && tar zxvf /fastDFS/download/db-${BERKELEY_DB_VERSION}.tar.gz -C /fastDFS/download
