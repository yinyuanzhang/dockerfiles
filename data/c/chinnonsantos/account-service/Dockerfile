...
# Creating labels
LABEL version="1.0.0" description="Account microservices demo" "br.com.chinnonsantos.vendor"="Chinnon Santos - Software Engineer" "br.com.chinnonsantos.email"="contato@chinnonsantos.com.br" "br.com.chinnonsantos.repository"="https://github.com/chinnonsantos/account-service"
...
RUN ["sh", "-c", "mkdir /home/account-service"]
...
RUN ["sh", "-c", "cp target/account-1.0.0.jar ."]
RUN ["sh", "-c", "rm -rf /var/lib/apt/lists/ /tmp/ /var/tmp/ /root/.lein/ /root/.m2/ /root/.wget-hsts /usr/local/bin/lein /home/account-service/project.clj /home/account-service/src/ /home/account-service/target/ /home/account-service/test/"]

# Specifying network ports
EXPOSE 9001/tcp

# Starting service (run standalone artifact)
CMD ["account-1.0.0.jar"]
ENTRYPOINT ["java", "-jar"]