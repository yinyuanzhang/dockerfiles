...
ADD . "$GOPATH/src/github.com/Financial-Times/people-rw-neo4j"

WORKDIR "$GOPATH/src/github.com/Financial-Times/people-rw-neo4j"

RUN apk --no-cache --virtual .build-dependencies add git \
    && apk --no-cache --upgrade add ca-certificates \
    && update-ca-certificates --fresh \
    && git config --global http.https://gopkg.in.followRedirects true \
    && cd $GOPATH/src/github.com/Financial-Times/people-rw-neo4j \
