...
# RUN apt-get install -y libc6:i386 libncurses5:i386 libstdc++6:i386 libgcc1:i386 zlib1g:i386 lib32z1
...
RUN cd /opt && \
    ...
    echo y | android update sdk --no-ui -a --filter build-tools-${ANDROID_BUILD_TOOLS_VERSION}
