...
RUN grep -E "RUN_AS_USER|PROXY_DIR|SECRET_PATH|FCGI_SOCKET|USER_FACING_PORT|ALLOW_RTMP_PROXY|LOCAL_LIB_DIR|DB_DRIVER|DB_DRIVER|DB_SERVER|DB_NAME|DB_USER|DB_PASS|USE_DB_FOR_COOKIES" /opt/cgiproxy/nph-proxy.cgi
