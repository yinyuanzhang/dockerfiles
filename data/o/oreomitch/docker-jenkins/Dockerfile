...
ADD https://services.gradle.org/distributions/gradle-1.12-bin.zip /opt/
RUN unzip /opt/gradle-1.12-bin.zip -d /opt/gradle
ENV GRADLE_HOME /opt/gradle/gradle-1.12
